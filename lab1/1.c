...
#include<math.h> 
#include<limits.h> 
long long conv_n_to_int(char*s,int*chck_rrr_n_n) {
    int i;
    int minus=0;
...
int entered_parameters_verify(int argc,char*argv,int chck_rrr_n_n) {
...
int main(int argc,char*argv[]) {
    ...
    n=conv_n_to_int(argv[1],&chck_rrr_n_n);
    
    ERRORS=entered_parameters_verify(argc,argv[2],chck_rrr_n_n);
